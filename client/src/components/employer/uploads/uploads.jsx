...
class EmployerUploads extends Component {
  constructor(props) {
    super(props);
  ...
  getFiles = async () => {
    ...
    const response = await employerInstance.get("/uploadedFiles");
    console.log("response.data, ", response.data);
    if (response.data.code === 200) {
      let imgs = response.data.images;
      const images = imgs.slice(1);
...
export default EmployerUploads;
      ...
      <tr>
        ...
        <td>
          <a
            ...
            target="_blank"
          ></a>{" "}
          <i onClick={this.delete} className="fa fa-trash fa-fw"></i>
        </td>
      </tr>
    );
  }
